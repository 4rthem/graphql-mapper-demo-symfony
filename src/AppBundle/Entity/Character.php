...
/**
 * @ORM\Entity(repositoryClass="AppBundle\Entity\CharacterRepository")
...
abstract class Character
{
    ...
    /**
     * @var Character[]
     * @ORM\ManyToMany(targetEntity="AppBundle\Entity\Character", cascade={"persist"}, inversedBy="friends")
